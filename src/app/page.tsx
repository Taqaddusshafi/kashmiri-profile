  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden bg-black transition-colors duration-500">
      ...
      <div className="fixed top-6 left-6 z-50 group">
        <div className="bg-gradient-to-r from-purple-600/20 to-cyan-600/20 backdrop-blur-xl border border-white/10 text-white px-6 py-3 rounded-2xl text-sm hover:scale-105 transition-all duration-300 shadow-2xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-xs text-gray-300">Visitor</div>
              <div className="font-bold text-lg" suppressHydrationWarning>
